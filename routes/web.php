...
Route::group(['prefix'=>'admin','as'=>'admin.'],function () {
    ...
    Route::post('/user/{user}/toggle-lock', [UserController::class, 'toggleLock'])->name('categories.toggle-lock');
    Route::post('/user/{user}/make-admin', [UserController::class, 'makeAdmin'])->name('categories.make-admin');
    Route::post('/{user}/remove-admin', [UserController::class, 'removeAdmin'])->name('user.remove-admin');
